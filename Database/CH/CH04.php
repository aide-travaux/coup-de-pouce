...
abstract class CH04 implements DatabaseInterface
{
    use DatabaseTrait;
     ...
     * @property string
     */
    const NOM = 'Pompe à chaleur hybride';

    /**
     * @property string
     */
    const CODE = 'CDP-CH-04';

    /**
     * @property string
     */
    const DENOMINATION = 'Remplacement d\'une chaudière individuelle au charbon, au fioul ou au gaz, autres 
                         qu\'à condensation, par une pompe à chaleur hybride';
