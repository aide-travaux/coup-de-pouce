...
use AideTravaux\CoupDePouce\Database\CH\CH03;
use AideTravaux\CoupDePouce\Model\DataInterface;

class CH03Test extends TestCase
{
    /**
    ...
    public function getMontant($model, $expect)
    {
        ...
        $this->assertEquals(CH04::getMontant($stub), $expect);
    }
    ...
    {
        $stub = $this->buildMock($model);
        $this->assertEquals(CH03::getMontantForfaitaire($stub), $expect);
    }
